...
driver =  webdriver.Chrome(executable_path="/home/xps/educate/code/hust/DS_20222/data-science-e10/crawler/chromedriver", chrome_options=options)
...
class TerrorismSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        url  = 'https://www.reddit.com/r/terrorism/'
        driver.get(url)
        num_scrolls = 200
